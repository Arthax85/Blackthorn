...
// Configurar variables JWT (añadir al .env)
...
// Actualizar el endpoint de registro para incluir JWT
app.post('/api/register', async (req, res) => {
  const { name, email, password } = req.body;
...
// Actualizar la tabla users para incluir role
// Añadir esto en la creación de la tabla (si no existe)
pool.query(`
  ALTER TABLE users 
...
app.get('/api/users', authenticateToken, async (req, res) => {
  try {
    ...
    // Obtener usuarios con todos los campos necesarios
    const result = await pool.query(
